	...
	<div class="banner">
		<!--轮播 -->
			<div class="am-slider am-slider-default scoll" data-am-flexslider
				id="demo-slider-0">
				<ul class="am-slides">
					<li class="banner1"><a href="introduction.html"> <img src="" /></a></li>
												...
												<div class="area-bg">
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																<dt>
																	<span title="蛋糕">分类</span>
																</dt>
																<dd>
																	<a title="蒸蛋糕" href="#"><span>子分类</span></a>
																	<a title="蒸蛋糕" href="#"><span>子分类</span></a>
																</dd>
															</dl>
															<dl class="dl-sort">
																<dt>
																	<span title="蛋糕">分类2</span>
																</dt>
																<dd>
																	<a title="蒸蛋糕" href="#"><span>子分类</span></a>
																	<a title="蒸蛋糕" href="#"><span>子分类</span></a>
				...
				<div class="demo">
					<ul>
								<li class="title-first"><a target="_blank"
									href="#"> <img
										src="../images/TJ2.jpg"></img> <span>[公告]</span>11
								</a></li>
								<li class="title-first"><a target="_blank"
									href="#"> <img
										src="../images/TJ2.jpg"></img> <span>[公告]</span>11
						...
						<div class="mod-vip">
							...
							<div class="clear"></div>
								...
								<li><a target="_blank" href="#"><span>[特惠]</span>1
								</a></li>
								<li><a target="_blank" href="#"><span>[特惠]</span>1
								</a></li>
					</ul>
				...
				<div id="f1">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
										<a class="outer" href="javascript:;"> <span
										class="inner"><b class="text">子分类</b></span></a>
										<a class="outer" href="javascript:;"> <span
										class="inner"><b class="text">子分类</b></span></a>
										<a class="outer" href="javascript:;"> <span
										class="inner"><b class="text">子分类</b></span></a>
