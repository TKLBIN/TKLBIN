								...
								<li>
									...
									<div class="fore3">
										<a href="password.html">
											<a href="#" class="am-btn am-btn-secondary">修改</a>
										</a>
									</div>
								</li>
								<li>
									...
									<div class="fore3">
										<a href="setpay.html">
											<a href="#" class="am-btn am-btn-secondary">立即启用</a>
										</a>
									</div>
								</li>
								<li>
									...
									<div class="m-left">
										...
										<div class="fore2"><small>您验证的邮箱：<u></u> 可用于快速找回登录密码</small></div>
									</div>
									<div class="fore3">
										<a href="email.html">
											<a href="#" class="am-btn am-btn-secondary" type="button">换绑</a>
										</a>
									</div>
								</li>
								<li>
