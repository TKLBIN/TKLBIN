            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="editForm" action="/shop-admin/sub/doInsert">
                   
                        	<div class="form-group">
                                <label class="col-sm-2 control-label">子分类名字</label>
                                <div class="col-sm-10">
                                    <input type="text"  class="form-control" name="classifySubName">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio i-checks">
                                        <label>
                                            <input type="radio" value="1" name="subIsOn"> <i></i> 启用</label>
                                    </div>
                                    <div class="radio i-checks">
                                        <label>
                                            <input type="radio" value="0" name="subIsOn"> <i></i> 禁用</label>
                                    </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
